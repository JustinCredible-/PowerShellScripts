...
while ($i -le $totalspots) {
  ...
  New-Mailbox -Name $displayname.replace(" ","") -DisplayName $displayname -Room -ResourceCapacity 1 | Set-CalendarProcessing -ScheduleOnlyDuringWorkHours $true -MaximumDurationInMinutes $maxappttime -WhatIf
}
